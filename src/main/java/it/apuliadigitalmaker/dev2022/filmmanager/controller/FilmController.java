...
import it.apuliadigitalmaker.dev2022.filmmanager.utility.ResponseGenerator;
...
public class FilmController {
	...
	@GetMapping("/{filmId}")
	public ResponseEntity<?> geFilm(@PathVariable(name="filmId", required=true) String filmId) {
	...
	@PutMapping("/{filmId}")
	public ResponseEntity<?> updateFilm(@PathVariable(name="filmId", required=true) String filmId, 
	...
	public ResponseEntity<?> deleteFilm(@PathVariable(name="filmId") String filmId){
